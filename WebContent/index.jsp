    ...
    <footer class="text-center text-lg-start">
        <div class="container p-4">
            <section class="mb-4">
                ...
                <a href="#" class="me-4 text-reset">Facebook</a>
                <a href="#" class="me-4 text-reset">Twitter</a>
                <a href="#" class="me-4 text-reset">Instagram</a>
                <a href="#" class="me-4 text-reset">LinkedIn</a>
            </section>
        </div>
        <div class="text-center p-3">
            <span>© 2024 VELVETVIBE. All rights reserved.</span>
        </div>
    </footer>
    <!-- Footer Ends -->
</body>
